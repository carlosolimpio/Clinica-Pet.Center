...
public class PanelListarOperador extends JPanel {
	...
	public PanelListarOperador(JFrame frame) {
		...
		lblIdOperador.setBounds(286, 23, 86, 14);
		add(lblIdOperador);
		...
		btnCadastrar.setBounds(481, 351, 93, 23);
		add(btnCadastrar);
		
		JButton btnVoltarPanelAdm = new JButton("Voltar");			   //======================VOLTAR
		btnVoltarPanelAdm.setBounds(329, 351, 93, 23);
		...
		btnRemover.setBounds(166, 351, 93, 23);
		add(btnRemover);
		
		JButton btnAtualizar = new JButton("Atualizar");
		btnAtualizar.setBounds(20, 351, 93, 23);
		add(btnAtualizar);
		
		tfListarOperador = new JTextField();
		tfListarOperador.setBounds(21, 93, 553, 235);
